		...
		switch($arrTag[0]) {
			...
			case 'user_image':
				...
				if($objMember) {
					...
					return "<img alt='".$imgMeta[0]."' title='".$imgMeta[1]."' caption='".$imgMeta[2]."' link='".$imgMeta[3]."' width='".$imgSize[0]."' height='".$imgSize[1]."' class='user_image' id='user_image id_" . $arrTag[1] . "' src='" . $strPath . "'>";
				}
